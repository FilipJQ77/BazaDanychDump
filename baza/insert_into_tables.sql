...
# meeting 2
INSERT INTO meetings (rank_id, arena_id, m_date,m_description) VALUES
('usual', 'Kal', '2020-05-20', 'Kalisz 2020');

INSERT INTO signups (athlete_id, meeting_id, discipline_id)   
SELECT athlete_id,2,1			
FROM athletes
WHERE athlete_id <= 8;

INSERT INTO series (discipline_id, meeting_id, s_type) VALUES
(1,2,'final');

INSERT INTO track_results (athlete_id, series_id, result) VALUES
(1,1,'00:00:10.22'),(2,1,'00:00:10.41'),(3,1,'00:00:10.50'),(4,1,'00:00:10.69'),(5,1,'00:00:10.80'),(6,1,'00:00:10.87'),(7,1,'00:00:10.99'),(8,1,'00:00:10.99');
